...
const translations = {
  en: {
    ...
    team: {
      ...
      t9Desc: "Engineering leader specializing in scalable backend architectures and applied AI. Proven track record in building autonomous DeFAI ecosystems, real-time risk engines, and enterprise RAG systems."
    },
    footer: {
  ...
  vi: {
    ...
    team: {
      ...
      t7Desc: "Chuyên gia thiết kế và vận hành hạ tầng công nghệ quy mô lớn. Từng công tác tại Vietcombank, với thế mạnh cốt lõi về DevOps, điện toán đám mây và đảm bảo độ ổn định tuyệt đối cho các hệ thống trọng yếu.",
      t8Desc: "Chuyên gia UX/UI và Frontend với nhiều năm dẫn dắt các dự án Enterprise và Web3. Từng là Tech Lead tại VNPT Media, am hiểu sâu sắc việc tối ưu hóa và thiết kế trải nghiệm số lấy người dùng làm trung tâm.",
      t9Desc: "Lãnh đạo kỹ thuật chuyên sâu về kiến trúc backend mở rộng và AI ứng dụng. Sở hữu thành tích thực chiến trong xây dựng hệ sinh thái AI tự trị (DeFAI), công cụ quản trị rủi ro thời gian thực và hệ thống RAG doanh nghiệp."
    },
    footer: {
  ...
  ja: {
    ...
    team: {
      ...
      t7Desc: "大規模インフラストラクチャ設計・運用のスペシャリスト。Vietcombankでの経験を活かし、DevOps、クラウドアーキテクチャ、ミッションクリティカルなシステムの高可用性（HA）担保を強みとする。",
      t8Desc: "エンタープライズおよびWeb3向けUX/UI・フロントエンド開発のエキスパート。VNPT Mediaでのテックリード経験を持ち、スケーラブルでユーザー中心のデジタル体験設計に精通。",
      t9Desc: "拡張性の高いバックエンドと応用AIを専門とするエンジニアリングリーダー。自律型DeFAIエコシステムやエンタープライズRAGシステム、リアルタイムリスクエンジンの構築で確かな実績を持つ。"
    },
    footer: {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <TeamCard 
              ...
              bio={t.team.t5Desc}
              imageSrc={`${CDN_BASE}/joies-nguyen.jpg`}
            />
            <TeamCard 
              name="Harris Vu" 
              role="Head of AI" 
